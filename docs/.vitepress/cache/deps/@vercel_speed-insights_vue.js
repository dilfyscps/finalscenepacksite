...
// optional-peer-dep:__vite-optional-peer-dep:vue-router:@vercel/speed-insights:false
var require_speed_insights_false = __commonJS({
  "optional-peer-dep:__vite-optional-peer-dep:vue-router:@vercel/speed-insights:false"(exports, module) {
    module.exports = {};
    throw new Error(`Could not resolve "vue-router" imported by "@vercel/speed-insights". Is it installed?`);
  }
});

// node_modules/@vercel/speed-insights/dist/vue/index.mjs
var import_vue_router = __toESM(require_speed_insights_false(), 1);
